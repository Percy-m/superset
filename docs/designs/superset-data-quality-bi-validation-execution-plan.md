...
| ID       | 操作/命令                                                                                                   | 断言                                                                                                                           | 清理/证据                |
| -------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------------------ |
| `V4-T01` | 先运行 Samples/排序/容量 unit，再运行精确 Samples、embedded、`drill_info` 节点和 RLS 回归；真实 count/data 留给 T03 | FR-01 server/bounded 模式、搜索、稳定排序、Dataset deny、RLS 后 count/data 一致 | 每组从只读 baseline 复制；pytest 回滚 |
...
| `V4-T01A`     | PASS    | Python unit + 隔离 SQLite/Redis             | Drill Detail 排序、容量和查询 action `18/18`；精确 Samples/embedded/`drill_info` `16/16`；通用 RLS 数据限制与 cache key `2/2`。真实 ClickHouse Samples count/data 与边界矩阵仍归 T03，不据此关闭 T01。                                                                                                           |
...
| `V4-*`        | IN_PROGRESS | —                                        | T03、T05 以及 T01/T02/T04 的真实剩余项未完成；不得进入 V5。                                                                                                                                                                                                                                                                                                              |
| `V5-*`        | PENDING | —                                           | —                                                                                                                                                                                                                                                                                                                                                                       |
| `V6-*`        | PENDING | —                                           | —                                                                                                                                                                                                                                                                                                                                                                       |
| `V7-*`        | PENDING | —                                           | —                                                                                                                                                                                                                                                                                                                                                                       |
| `V8-*`        | PENDING | —                                           | —                                                                                                                                                                                                                                                                                                                                                                       |
