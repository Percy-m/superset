...
| 属性        | 内容                                                                                                        |
| ----------- | ----------------------------------------------------------------------------------------------------------- |
| 版本 / 日期 | V1.3 / 2026-08-29；排除默认 Cell Bar 筛选色，保留 formatter Cell Bar，移除色块颜色名 Tooltip                |
...
| 色块文案            | 只显示色块，不显示颜色名 Tooltip 或原生 title；保留辅助技术名称和 aria-checked             |
...
Cell Bar 的正常绘制和筛选。最新一轮联合验证为前端 25 suites / 549 tests、
后端 416 tests，真实 HTTP 全流程 28 项；逐项证据见上述验收记录第 7 节。
