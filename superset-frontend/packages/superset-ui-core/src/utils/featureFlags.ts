...
export enum FeatureFlag {
  ...
  DashboardTabXlsxExport = 'DASHBOARD_TAB_XLSX_EXPORT',
  ...
  DrillDetailConfigurableTable = 'DRILL_DETAIL_CONFIGURABLE_TABLE',
  /** @deprecated */
  ...
  StyledXlsxExport = 'STYLED_XLSX_EXPORT',
  TableAlertFilters = 'TABLE_ALERT_FILTERS',
